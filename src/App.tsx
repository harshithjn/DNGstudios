...
function App() {
  ...
  const { loadScorePage, saveNotes, addNote, removeNote, updateProject } = useSupabase()
  ...
  }, [historyState, currentProject, textElements, articulationElements, setTextElements, setArticulationElements, currentPageIndex])
