...
import { ArrowLeft, Music2, Keyboard, Mouse, Piano, Type, Pen, Eraser, Download, Users, RotateCcw, Settings, FileText, Star, Zap, Brain, Shield, Code, Play, Volume2, Clock, Palette, Layers, Share2, Database, Cloud, Lock, Smartphone, Monitor } from 'lucide-react'
